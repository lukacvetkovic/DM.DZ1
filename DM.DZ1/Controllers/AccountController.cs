        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        Name = id.Claims.FirstOrDefault(p => p.Type == "urn:facebook:name")?.Value
                    };

                    return RedirectToAction("UpdateUserData", "Home", new { Name = userInfo.Name, Email = userInfo.Email, Location = userInfo.Location });
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.RequiresVerification:
