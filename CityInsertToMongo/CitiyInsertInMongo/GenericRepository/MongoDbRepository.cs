...
namespace DataModel.GenericRepository
{
    public class MongoDbRepository : IMongoDbRepository
    {
        ...
        {
            _mongoDbContext = MongoDbContext.GetInstanceInstance;
        }
        ...
        public Result AddOneSync<TEntity>(TEntity item) where TEntity : class, new()
        {
            var res = new Result();
            try
            {
        ...
        public GetManyResult<TEntity> GetAllSync<TEntity>() where TEntity : class, new()
        {
            var res = new GetManyResult<TEntity>();
            try
            {
        ...
        public async Task<Result> AddMany<TEntity>(TEntity[] item) where TEntity : class, new()
        {
            var res = new Result();
            try
            {
                var collection = GetCollection<TEntity>();
                await collection.InsertManyAsync(item.ToList());
                res.Success = true;
                res.Message = "OK";
                return res;
            }
